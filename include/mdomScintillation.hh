...
#ifndef mdomScintillation_h
#define mdomScintillation_h 1
...
class mdomScintillation : public G4VRestDiscreteProcess
{
...
public:
	...
	mdomScintillation(const G4String& processName = "Scintillation",
                                 G4ProcessType type = fElectromagnetic);
	~mdomScintillation();	

private:

        mdomScintillation(const mdomScintillation &right);
...
inline 
G4bool mdomScintillation::IsApplicable(const G4ParticleDefinition& aParticleType)
{
...
inline 
void mdomScintillation::SetTrackSecondariesFirst(const G4bool state) 
{
	fTrackSecondariesFirst = state;
}

inline
void mdomScintillation::SetFiniteRiseTime(const G4bool state)
{
        fFiniteRiseTime = state;
}

inline
G4bool mdomScintillation::GetTrackSecondariesFirst() const
{
        return fTrackSecondariesFirst;
}

inline 
G4bool mdomScintillation::GetFiniteRiseTime() const
{
        return fFiniteRiseTime;
}

inline
void mdomScintillation::SetScintillationYieldFactor(const G4double yieldfactor)
{
        YieldFactor = yieldfactor;
}

inline
G4double mdomScintillation::GetScintillationYieldFactor() const
{
        return YieldFactor;
}

inline
void mdomScintillation::SetScintillationExcitationRatio(const G4double excitationratio)
{
        ExcitationRatio = excitationratio;
}

inline
G4double mdomScintillation::GetScintillationExcitationRatio() const
{
        return ExcitationRatio;
}

inline
G4PhysicsTable* mdomScintillation::GetSlowIntegralTable() const
{
        return theSlowIntegralTable;
}

inline
G4PhysicsTable* mdomScintillation::GetFastIntegralTable() const
{
        return theFastIntegralTable;
}

inline
G4PhysicsTable* mdomScintillation::GetfirstIntegralTable() const
{
        return firstIntegralTable;
}

inline
G4PhysicsTable* mdomScintillation::GetsecondIntegralTable() const
{
        return secondIntegralTable;
}

inline
G4PhysicsTable* mdomScintillation::GetthirdIntegralTable() const
{
        return thirdIntegralTable;
}

inline
void mdomScintillation::DumpPhysicsTable() const
{
...
inline
G4double mdomScintillation::single_exp(G4double t, G4double tau2)
{
         return std::exp(-1.0*t/tau2)/tau2;
}

inline
G4double mdomScintillation::bi_exp(G4double t, G4double tau1, G4double tau2)
{
